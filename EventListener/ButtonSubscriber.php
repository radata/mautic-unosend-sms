...
namespace MauticPlugin\UnosendSmsBundle\EventListener;
...
class ButtonSubscriber implements EventSubscriberInterface
{
    ...
    {
        $myIntegration = $this->helper->getIntegrationObject('UnosendSms');
            ...
            $event->addButton(
                [
                    'attr' => [
                        ...
                        'data-header' => $this->translator->trans('unosend_sms.send.header'),
                        'href'        => $this->router->generate(
                            'mautic_plugin_unosendsms_action',
                            ['objectAction' => 'sendSms', 'objectId' => $contactId]
                        ),
                    ],
                    'btnText'   => $this->translator->trans('unosend_sms.send.button'),
